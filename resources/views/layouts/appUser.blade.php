        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="m-0"><i class="fa-solid fa-location-dot"></i> User<span class="fs-5"> Zone</span></h1>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('img/portfolio-1.jpg') }}
                                " alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('img/portfolio-2.jpg') }}
                                " alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('img/portfolio-3.jpg') }}
                                " alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('img/portfolio-4.jpg') }}
                                " alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('img/portfolio-5.jpg') }}
                                " alt="Image">
                            </div>
                            <div class="col-4">
                                <img class="img-fluid" src="{{ asset('img/portfolio-6.jpg') }}
                                " alt="Image">
                            </div>
                        </div>
                    </div>
