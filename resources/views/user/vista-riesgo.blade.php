...
<div class="container">
    <h2 style="color: #fff" class="mb-4">Reporte de Zonas de Riesgo</h2>
...
function initMap() {
    ...
    const zonas = @json($zonas); // asegúrate de pasar la variable $riesgos desde el controlador

    zonas.forEach(riesgo => {
        const coordenadas = [
        ...
        // Centrar marcador en la primera coordenada
    ...
    // Captura el mapa y genera el PDF
